...
import 'package:ecommerce_mark1/utils/constants/enums.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        /// Title
        const TProductTitleText(title: 'Really Cool Jacket'),
        const SizedBox(height: TSizes.spaceBtwItems / 1.5),
        ...
        /// Brand
         Row(
          children: [
            ...
            const TBrandTitleTextWithVerifiedIcon(title: 'Adidas', brandTextSize: TextSizes.medium),
          ],
        )
      ],
    );
